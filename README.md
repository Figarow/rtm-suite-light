# RTM Suite Testversion 1.1 — Defensive Security Workbench
...
➡️ **[Jetzt kostenlos herunterladen](https://figarow.github.io/rtm-suite-testversion/)**

---

## 🚀 Was ist RTM Suite Testversion?

RTM Suite Testversion ist die kostenlose, proprietäre Edition (keine Open-Source-Lizenz) für autorisierte, defensive Sicherheitsprüfungen auf dem eigenen Linux-System:
...
Alle Details, Download-Paket (mit SHA-256-Prüfsummen), Vorstellungsvideo und rechtliche Hinweise findest du auf der **[Downloadseite](https://figarow.github.io/rtm-suite-testversion/)**.

## 💾 Downloads

| Plattform | Status | Paket |
|---|---|---|
| Linux | ✅ getestet | [RTM-Suite-Testversion-1.1.zip](https://figarow.github.io/rtm-suite-testversion/downloads/RTM-Suite-Testversion-1.1.zip) |
| Windows | ⚠️ **Experimental, Build 1.0** | [RTM-Suite-Testversion-1.0-windows-EXPERIMENTAL.zip](https://figarow.github.io/rtm-suite-testversion/downloads/RTM-Suite-Testversion-1.0-windows-EXPERIMENTAL.zip) |
...
RTM Suite Testversion führt seine Prüfungen nicht isoliert aus, sondern steuert bewährte, separat zu installierende Systemwerkzeuge auf dem eigenen Linux-Rechner an. Diese Werkzeuge sind **nicht** Bestandteil des Downloads und müssen aus einer rechtmäßigen Quelle eigenständig installiert werden:
...
RTM Suite Testversion bleibt dauerhaft kostenlos nutzbar. Eine erweiterte Edition mit zusätzlichen Analyse- und Berichtsfunktionen ist geplant. Informationen zu Lizenzmodell, Preis und Verfügbarkeit werden vor Veröffentlichung gesondert über denselben Kanal wie dieser Download bereitgestellt.

## 💛 Freiwillig unterstützen

Download und Nutzung von RTM Suite Testversion sind und bleiben kostenlos. Eine finanzielle Unterstützung ist freiwillig, erfolgt ohne Gegenleistung und beeinflusst weder Funktionsumfang noch Updates oder Support. Es handelt sich nicht um eine steuerlich absetzbare Spende im Sinne des österreichischen Spendenrechts; es wird keine Spendenbescheinigung ausgestellt.
...
Für Hinweise zu Sicherheitslücken in RTM Suite Testversion oder RTM Pwn Guard: [birdwithbeard@gmx.at](mailto:birdwithbeard@gmx.at?subject=Sicherheitsmeldung%20RTM%20Suite%20Testversion). Bitte betroffene Version, Reproduktionsschritte und Auswirkungen beschreiben, keine ungeschwärzten echten Scan-/Evidence-Daten mitsenden und vor Veröffentlichung von Details eine angemessene Behebungsfrist einräumen. Unterstützt wird die aktuell veröffentlichte Version 1.1.
